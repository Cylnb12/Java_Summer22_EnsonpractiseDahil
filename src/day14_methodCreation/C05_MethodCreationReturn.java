...
public class C05_MethodCreationReturn {
    public static void main(String[] args) {
        ...
        kodumuzu sade ve anlasilir tutmak icin islemi
        bir method da yapip sonucunu main method a dondurebiliriz
        Return type i void olmayan bir methodun sonucunu
        main method da bir variable ye atarsak programin
        geri kalaninda bu yeni degeri kullanma sansimiz olur
         */
        ...
        //tarihi isie 2022-06-30 seklinde istiyoruz
    ...
    public static String tarihAl() {
        ...
        System.out.println("lutfen ayin kacinci gunu oldugunu tamsayi oarak giriniz");
