...
public class C03_Exceptions {
    public static void main(String[] args) {
        ...
        /*
        Kullanicidan String olarak bir deger aliyo ve bunu integer ar ceviriyorsak
        ...
        kodum durmasin istyorsak
        bir kere daha catch cumleis ekleyip
        ona da en genis Exception u yazabiliriz
