...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("kurs adi iceriyor mu : "+kursadiIceriyormu(coursesList,"Turkish"));
        System.out.println(ortalamaPuaniEnyuksekolanKursunAdi(coursesList));
        System.out.println(ortalamaPuanaGoreSirala(coursesList,1));
...
public static boolean kursadiIceriyormu (List<Courses>list,String kelime){
...
//3) Ortalama puanı en yüksek olan kursu yazdırmak için bir yöntem oluşturun
    public static String ortalamaPuaniEnyuksekolanKursunAdi (List<Courses>list){
